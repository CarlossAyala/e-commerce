...
export const findAllStockAlert = async (query, accessToken) => {
...
export const updateStockAlert = async (productId, values, accessToken) => {
  const url = `${ENDPOINT}/${productId}/stock-alert`;
