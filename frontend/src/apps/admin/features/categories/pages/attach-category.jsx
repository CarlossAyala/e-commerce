...
import { FormAttachCategory } from "../components/form-attach-category";
...
export const AttachCategory = () => {
  ...
  return (
    <main className="space-y-4 p-4">
      ...
      {isLoading && <FormAttachCategory.Skeleton />}
      {isError && (
        <EmptyPlaceholder>
      ...
      {hasCategories && <FormAttachCategory categories={categories} />}
    </main>
  );
};
