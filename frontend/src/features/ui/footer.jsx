...
const Footer = () => {
  ...
  return (
    <footer className='mx-auto w-full max-w-7xl border-t border-slate-200'>
      <div>
        ...
        {/* Navigation */}
        {/* <div className='grid grid-cols-2 gap-6 px-4 pt-4 pb-5'>
          <div>
            <h4 className='font-semibold uppercase text-gray-900 dark:text-gray-100'>
              Company
            </h4>
